...
#define gt_test_case(name) while (gt_explicit_test_case(#name) == GT_LOOP_ENTER)
...
#define gt_assert(a, mode, b)                                                            \
  {                                                                                      \
    gt_expression x = {                                                                  \
        .expression = #a, .generic = gt_genericof(a), .type = gt_typeof(a)};             \
    gt_expression y = {                                                                  \
        .expression = #b, .generic = gt_genericof(b), .type = gt_typeof(b)};             \
...
#define gt_get_data(function) (GT_STRUCT_OF(function)*)gt_explicit_get_data()
